...
import 'package:ricardo/feature/view/home/map/report_screen.dart';
...
abstract class AppRoutes {
  ...
  static const String forgetPasswordOtpVerifyScreen =
  ...
  static const String uploadDrivingLicenseScreen =
      '/upload_driving_license_screen';
  static const String carRegistrationScreen = '/car_registration_screen';
  static const String profileCompletePopupModelScreen =
      '/profile_complete_popup_modal_screen';
  static const String homeScreen = '/home_screen';
  static const String customBottomNavBar = '/custom_bottom_nav_bar';
  static const String paymentMethodsSelectionScreen =
      '/payment_mathods_selection_screen';
  ...
  static final routes = <String, WidgetBuilder>{
    ...
    profileCompletePopupModelScreen: (context) =>
        ProfileCompletePopupModalScreen(),
